...
public class Board extends JPanel
{
  ...
  */
  ...
  private void fillAndUpdateMap(Graphics g , int x, int y, int w, int h) {
    g.fillRect(x,y,w,h);
    updateMap(x,y,w,h);
  }
  ...
  public void drawBoard(Graphics g)
  {
    ...
    fillAndUpdateMap(g,40,40,60,20);
    fillAndUpdateMap(g,120,40,60,20);
    fillAndUpdateMap(g,200,20,20,40);
    fillAndUpdateMap(g,240,40,60,20);
    fillAndUpdateMap(g,320,40,60,20);
    fillAndUpdateMap(g,40,80,60,20);
    fillAndUpdateMap(g,160,80,100,20);
    fillAndUpdateMap(g,200,80,20,60);
    fillAndUpdateMap(g,320,80,60,20);


    fillAndUpdateMap(g,20,120,80,60);
    fillAndUpdateMap(g,320,120,80,60);
    fillAndUpdateMap(g,20,200,80,60);
    fillAndUpdateMap(g,320,200,80,60);


    fillAndUpdateMap(g,160,160,40,20);
    fillAndUpdateMap(g,220,160,40,20);
    fillAndUpdateMap(g,160,180,20,20);
    fillAndUpdateMap(g,160,200,100,20);
    fillAndUpdateMap(g,240,180,20,20);

    g.setColor(Color.BLUE);


    fillAndUpdateMap(g,120,120,60,20);
    fillAndUpdateMap(g,120,80,20,100);
    fillAndUpdateMap(g,280,80,20,100);
    fillAndUpdateMap(g,240,120,60,20);


    fillAndUpdateMap(g,280,200,20,60);
    fillAndUpdateMap(g,120,200,20,60);
    fillAndUpdateMap(g,160,240,100,20);
    fillAndUpdateMap(g,200,260,20,40);


    fillAndUpdateMap(g,120,280,60,20);
    fillAndUpdateMap(g,240,280,60,20);


    fillAndUpdateMap(g,40,280,60,20);
    fillAndUpdateMap(g,80,280,20,60);
    fillAndUpdateMap(g,320,280,60,20);
    fillAndUpdateMap(g,320,280,20,60);


    fillAndUpdateMap(g,20,320,40,20);
    fillAndUpdateMap(g,360,320,40,20);
    fillAndUpdateMap(g,160,320,100,20);
    fillAndUpdateMap(g,200,320,20,60);


    fillAndUpdateMap(g,40,360,140,20);
    fillAndUpdateMap(g,240,360,140,20);
    fillAndUpdateMap(g,280,320,20,40);
    fillAndUpdateMap(g,120,320,20,60);
